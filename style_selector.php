...
#style_selector .images a { background: url(<?php echo get_template_directory_uri(); ?>/images/style-selector.png) no-repeat top left; display: inline-block; margin-bottom: 7px; margin-right: 7px;}
