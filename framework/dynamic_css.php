...
.sb-toggle-wrapper {
	border-top-color:<?php echo $smof_data['slidingbar_bg_color']; ?>;
...
<?php endif; ?>
<?php endif; ?>
<?php if( $smof_data['header_layout'] == 'v1' ): ?>
...
.mobile-nav-holder .mobile-selector, .mobile-topnav-holder .mobile-selector, #mobile-nav, #mobile-nav li a, #mobile-nav li a:hover, .mobile-nav-holder .mobile-selector .selector-down, .mobile-menu-design-modern .header-wrapper #mobile-nav { border-color: <?php echo $smof_data['mobile_menu_border_color']; ?>; }
.mobile-nav-holder .mobile-selector .selector-down:before, .mobile-menu-icons a, .mobile-menu-icons a:before{color:<?php echo $smof_data['mobile_menu_border_color']; ?>;}
<?php endif; ?>
...
#wrapper .fusion-megamenu-wrapper {
	width:<?php echo $megamenu_width . 'px'; ?>;
}

@media (min-width: 800px ) {
	#wrapper .fusion-megamenu-wrapper.col-span-2 {
		width: <?php echo $megamenu_width / 6  . 'px'; ?>;
	}
	#wrapper .fusion-megamenu-wrapper.col-span-4 {
		width: <?php echo $megamenu_width / 3  . 'px'; ?>;
	}
	#wrapper .fusion-megamenu-wrapper.col-span-6 {
		width: <?php echo $megamenu_width / 2 . 'px'; ?>;
	}
	#wrapper .fusion-megamenu-wrapper.col-span-8 {
		width: <?php echo $megamenu_width * 2 / 3  . 'px'; ?>;
	}	
	#wrapper .fusion-megamenu-wrapper.col-span-10 {
		width: <?php echo $megamenu_width * 5 / 6  . 'px'; ?>;
	}
}
*/
...
.fusion-accordian .panel-title a,.fusion-sharing-box h4{font-size:<?php echo $smof_data['h4_font_size']; ?>px;}
<?php endif; ?>
...
#slidingbar-area a, #slidingbar-area #jtwt .jtwt_tweet a, #wrapper #slidingbar-area .fusion-tabs-widget .tab-holder .tabs li a{color:<?php echo $smof_data['slidingbar_link_color']; ?>;}
<?php endif; ?>
...
.footer-area a,.footer-area #jtwt .jtwt_tweet a,#wrapper .footer-area .fusion-tabs-widget .tab-holder .tabs li a,.footer-area .fusion-tabs-widget .tab-holder .news-list li .post-holder a,.copyright a{color:<?php echo $smof_data['footer_link_color']; ?>;}
<?php endif; ?>
...
#wrapper .sidebar .fusion-tabs-widget .tab-holder,.sidebar .fusion-tabs-widget .tab-holder .news-list li{border-color:<?php echo $smof_data['tabs_inactive_color']; ?>;}
...
.grid-layout .post,.timeline-layout .post,.blog-timeline-layout .post, .portfolio .portfolio-boxed .portfolio-item-wrapper{background-color:<?php echo $smof_data['timeline_bg_color']; ?>;}
<?php endif; ?>
