<ul class="pyre_metabox_tabs">
	<li class="active"><a href="sliders">Sliders</a></li>
...
<div class="pyre_metabox">
	...
	<div class="pyre_metabox_tab" id="pyre_tab_page">
		...
		$this->select(	'show_first_featured_image',
						...
						array('no' => 'No', 'yes' => 'Yes'),
						'Disable the 1st featured image on page.'
					);
		?>		
	</div>
	...
	<div class="pyre_metabox_tab" id="pyre_tab_portfolio">
		...
		$this->select(	'portfolio_content_length',
						'Excerpt or Full Portfolio Content',
						array('default' => 'Default', 'excerpt' => 'Excerpt', 'full_content' => 'Full Content' ),
						'Choose to show a text excerpt or full content.'
					);
		?>	
		<?php
		...
		$this->select(	'portfolio_text_layout',
						...
						array('default' => 'Default', 'boxed' => 'Boxed', 'unboxed' => 'Unboxed'),
						'Select if the portfolio text layouts are boxed or unboxed.'
					);
		?>		
		<?php
