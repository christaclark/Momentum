...
// Set the Options Array
		...
		$of_options[] = array( "name" => __("Tracking Code", "Avada"),
			"desc" => __("Paste your Google Analytics (or other) tracking code here. This will be added into the footer template of your theme. Please put code inside script tags.", "Avada"),
			"id" => "google_analytics",
			"std" => "",
			"type" => "textarea");
	   ...
	   $of_options[] = array( "name" => __("Content + Sidebar + Sidebar Width", "Avada"),
		...
		$of_options[] = array( "name" => __("Transparent Header", "Avada"),
			"desc" => __("Check this box to enable a transparent header that will display your slider behind it.", "Avada"),
			"id" => "header_transparent",
			"std" => 0,
			"type" => "checkbox");

		$of_options[] = array( "name" => __("Slider Position", "Avada"),
			"desc" => __("Select if the slider shows below or above the header. This only works for the slider assigned in page options, not with shortcodes.", "Avada"),
			"id" => "slider_position",
			"std" => "Below",
			"type" => "select",
			"options" => array('Below' => 'Below', 'Above' => 'Above'));

		$of_options[] = array( "name" => __("Header Top Left Content", "Avada"),
			"desc" => __("Select which content displays in the top left area of the header.", "Avada"),
		...
		$of_options[] = array( "name" => __("Header Top Right Content", "Avada"),
			"desc" => __("Select which content displays in the top right area of the header.", "Avada"),
			"id" => "header_right_content",
			"std" => "Navigation",
			"type" => "select",
			 "options" => array('Contact Info' => 'Contact Info', 'Social Links' => 'Social Links', 'Navigation' => 'Navigation', 'Leave Empty' => 'Leave Empty'));

		$of_options[] = array( "name" => __("Header Content Area For Header #4", "Avada"),
			"desc" => __("Select which content displays in the right area of Header 4.", "Avada"),
			"id" => "header_v4_content",
			"std" => "Tagline + Search",
			"type" => "select",
			"options" => array('Tagline' => 'Tagline', 'Search' => 'Search', 'Tagline And Search' => 'Tagline And Search', 'Banner' => 'Banner'));

		$of_options[] = array( "name" => __("Banner Code For Header #4", "Avada"),
			"desc" => __("Add HTML banner code for Header #4. The banner or image will display in Header 4 as long as you have Banner selected for the Header Content Area For Header #4 option above.", "Avada"),
			"id" => "header_banner_code",
			"std" => '',
			"type" => "textarea");

		$of_options[] = array( "name" => __("Header Phone Number", "Avada"),
			"desc" => __("Phone number will display in the Contact Info section of your top header.", "Avada"),
			"id" => "header_number",
			"std" => "Call Us Today! 1.555.555.555",
			"type" => "textarea");

		$of_options[] = array( "name" => __("Header Email Address", "Avada"),
			"desc" => __("Email address will display in the Contact Info section of your top header.", "Avada"),
			"id" => "header_email",
			"std" => "info@yourdomain.com",
			"type" => "text");

		$of_options[] = array( "name" => __("Header Tagline", "Avada"),
			"desc" => __("Tagline will display on Header 4 as long as you have Tagline selected for the Header Content Area For Header #4 option above.", "Avada"),
			"id" => "header_tagline",
		...
		$of_options[] = array( "name" => __("Parallax Background Image", "Avada"),
			"desc" => __("Check this box to enable parallax background image when scrolling.", "Avada"),
		...
		$of_options[] = array( "name" => __("Sticky Header Opacity", "Avada"),
			"desc" => __("Header v2 - v5 only. Set the opacity of background, <br />0.1 (lowest) to 1 (highest).", "Avada"),
		...
		$of_options[] = array( "name" => __("Logo Alignment", "Avada"),
			"desc" => __("Note: center only works on Header 5.", "Avada"),
			"id" => "logo_alignment",
			"std" => "Left",
			"type" => "select",
		...
		$of_options[] = array( "name" => __("Main Nav Height", "Avada"),
			"desc" => __("Use a number without 'px', default is 83. ex: 83", "Avada"),
			"id" => "nav_height",
			"std" => "83",
			"type" => "text");

		$of_options[] = array( "name" => __("Menu Item Padding", "Avada"),
			"desc" => __("Use a number without 'px', default is 45. ex: 45", "Avada"),
			"id" => "nav_padding",
			"std" => "45",
			"type" => "text");

		$of_options[] = array( "name" => __("Mobile Menu Item Padding", "Avada"),
			"desc" => __("Use a number without 'px', default is 25. ex: 25", "Avada"),
		...
		$of_options[] = array( "name" => __("Enable Transparency on the Sliding Bar", "Avada"),
			"desc" => __("Check the box to enable transparency on the Sliding Bar.", "Avada"),
		...
		$of_options[] = array( "name" => __("Default Sidebar Position", "Avada"),
		...
		$of_options[] = array( "name" => __("Activate Global Sidebar", "Avada"),
			"desc" => __("Check the box if you want to use a global sidebar on all single posts. This option overrides the portfolio options.", "Avada"),
		...
		$of_options[] = array( "name" => __("Blog Sidebar Position", "Avada"),
		...
		$of_options[] = array( "name" => __("Activate Global Sidebar", "Avada"),
			"desc" => __("Check the box if you want to use a global sidebar on all single product pages. This option overrides the woocommerce options.", "Avada"),
		...
		$of_options[] = array( "name" => __("Activate Global Sidebar", "Avada"),
			"desc" => __("Check the box if you want to use one global sidebar on all forum pages.", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Background Colors", "Avada"),
		...
		$of_options[] = array( "name" => __("Sliding Bar Background Color", "Avada"),
			"desc" => __("Controls the color of the top sliding bar.", "Avada"),
			"id" => "slidingbar_bg_color",
			"std" => "#363839",
			"type" => "color");

		$of_options[] = array( "name" => __("Sticky Header Background Color", "Avada"),
			"desc" => __("Controls the background color for the sticky header.", "Avada"),
			"id" => "header_sticky_bg_color",
			"std" => "#ffffff",
			"type" => "color");

		$of_options[] = array( "name" => __("Header Background Color", "Avada"),
			"desc" => __("Controls the background color for the header.", "Avada"),
			"id" => "header_bg_color",
			"std" => "#ffffff",
			"type" => "color");
	   ...
	   $of_options[] = array( "name" => __("Element Colors", "Avada"),
		...
		$of_options[] = array( "name" => __("Rollover Image Gradient Top Color", "Avada"),
			"desc" => __("Controls the top color of the image rollover gradients.", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Layout Options", "Avada"),
		...
		$of_options[] = array( "name" => __("100% Width Left/Right Padding", "Avada"),
			"desc" => __("This option controls the left/right padding for page content when using 100% site width or 100% width page template.  Enter value in px. ex: 20px", "Avada"),
			"id" => "hundredp_padding",
			"std" => "20px",
			"type" => "text");
	   ...
	   $of_options[] = array( "name" => __("Main Menu Colors", "Avada"),
		...
		$of_options[] = array( "name" => __("Secondary Menu Font Color - First Level & Top Contact Info", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Accordion Shortcode", "Avada"),
			"desc" => "",
		...
		$of_options[] = array( "name" => __("Accordion Inactive Box Color", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Blog Shortcode", "Avada"),
		...
		$of_options[] = array( "name" => __("Counter Box Text Color", "Avada"),
			"desc" => __("Controls the color of the counter text and icon.", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Tabs Shortcode", "Avada"),
		...
		$of_options[] = array( "name" => __("Tabs Inactive Color", "Avada"),
			"desc" => __("Controls the color of the inactive tabs and the outer tab border.", "Avada"),
	   ...
	   $of_options[] = array( "name" => __("Testimonials Shortcode", "Avada"),
		...
		$of_options[] = array( "name" => __("Set All Post Items Full Width", "Avada"),
			"desc" => __("Check the box to turn all single post items to full width with no sidebar.", "Avada"),
		...
		$of_options[] = array( "name" => __("Title Font Size (px)", "Avada"),
			"desc" => __("Default is 42", "Avada"),
			"id" => "es_title_font_size",
			"std" => "42",
			"type" => "select",
			"options" => $font_sizes);

		$of_options[] = array( "name" => __("Caption Font Size (px)", "Avada"),
			"desc" => __("Default is 20", "Avada"),
		...
		$of_options[] = array( "name" => __("Custom Marker Icon", "Avada"),
			"desc" => __(" for our custom marker. For multiple addresses, separate icons by using the | symbol or use one for all. ex: Icon 1|Icon 2|Icon 3", "Avada"),
...
// Theme Specific Options
		...
		$of_options[] = array( "name" => "Google Maps Geocoding API Key (Optional)",
			"desc" => sprintf(__('Only enter an API key if maps are not already working. %s.', 'Avada'), '<a href="http://theme-fusion.com/knowledgebase/registering-google-map-api-key/">'.__('Click here to learn how to register an API key', 'Avada').'</a>'),
		...
		$of_options[] = array( "name" => __("Image Rollover Opacity", "Avada"),
			"desc" => __("Select the opacity of the rollover. <br />0.1 (lowest) to 1 (highest).", "Avada"),
		...
		$of_options[] = array( "name" => __("Disable Rich Snippets Sitewide", "Avada"),
			"desc" => __("Check the box to disable the modification date rich snippet from pages.", "Avada"),
		...
		$of_options[] = array( "name" => __("Woocommerce Related Product Number of Columns", "Avada"),
			"desc" => __("Select the number of columns for the related products on single post pages.", "Avada"),
